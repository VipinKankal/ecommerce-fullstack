...
final class ResponseMapperSupport {

    private ResponseMapperSupport() {
    }
    ...
    static ProductResponse toProductResponse(Product product) {
        ...
        response.setVariants(product.getVariants() == null ? Collections.emptyList() : product.getVariants().stream().map(ResponseMapperSupport::toVariantSummary).toList());
        return response;
    }

    static SellerResponse toSellerResponse(Seller seller) {
        if (seller == null) {
            return null;
        }
    ...
    static SellerOrderResponse toSellerOrderResponse(Order order) {
        if (order == null) {
            return null;
        }
        ...
        response.setOrderItems(order.getOrderItems() == null ? Collections.emptyList() : order.getOrderItems().stream().map(ResponseMapperSupport::toOrderItemSummary).toList());
        return response;
    }

    static OrderTaxSnapshotResponse toOrderTaxSnapshotResponse(OrderTaxSnapshot snapshot) {
        if (snapshot == null) {
            return null;
        }
