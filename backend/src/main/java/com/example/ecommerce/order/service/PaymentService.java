...
public interface PaymentService {
    ...
    PaymentOrder getPaymentOrderByMerchantTransactionId(String merchantTransactionId) throws Exception;
    Boolean ProceedPaymentOrder(PaymentOrder paymentOrder, String paymentId, String paymentLinkId) throws RazorpayException;
    void assertPhonePeConfigured();
    PhonePePaymentSession createPhonePePaymentSession(User user, PaymentOrder paymentOrder) throws Exception;
    PaymentOrder syncPhonePePaymentStatus(PaymentOrder paymentOrder) throws Exception;
