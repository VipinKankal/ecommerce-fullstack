...
import { verifySellerEmail } from 'State/features/seller/auth/thunks';

const SellerVerifyEmail = () => {
  const defaultEmail = useMemo(
    () =>
      globalThis.sessionStorage !== undefined
        ? globalThis.sessionStorage.getItem('pending_seller_email') || ''
        : '',
    [],
  );
  ...
  const handleVerify = async () => {
    ...
    if (verifySellerEmail.fulfilled.match(result)) {
      globalThis.sessionStorage.removeItem('pending_seller_email');
      setIsVerified(true);
    }
  };
