...
const BecomeSellerFormStep6 = ({ formik }: { formik: SellerAccountFormik }) => {
  ...
  return (
    <Box className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <TextField
        ...
        error={
          formik.touched.storeDetails?.storeName &&
          Boolean(formik.errors.storeDetails?.storeName)
        }
        helperText={
          formik.touched.storeDetails?.storeName &&
          formik.errors.storeDetails?.storeName
        }
      />
          ...
          {formik.values.storeDetails.storeLogo && (
            <Stack spacing={1.5}>
              ...
              <Button
                ...
                onClick={() =>
                  globalThis.open(
                    String(formik.values.storeDetails.storeLogo),
                    '_blank',
                    'noopener,noreferrer',
                  )
                }
      ...
      <TextField
        ...
        onChange={formik.handleChange}
        error={
          formik.touched.storeDetails?.supportEmail &&
          Boolean(formik.errors.storeDetails?.supportEmail)
        }
        helperText={
          formik.touched.storeDetails?.supportEmail &&
          formik.errors.storeDetails?.supportEmail
        }
      />
      <TextField
        fullWidth
        ...
        onChange={formik.handleChange}
        error={
          formik.touched.storeDetails?.supportPhone &&
          Boolean(formik.errors.storeDetails?.supportPhone)
        }
        helperText={
          formik.touched.storeDetails?.supportPhone &&
          formik.errors.storeDetails?.supportPhone
        }
      />
    </Box>
  );
