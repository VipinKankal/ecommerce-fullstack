...
import { Rating, LinearProgress, Divider } from "@mui/material";
      ...
      <section className="flex flex-col md:flex-row items-center gap-6 p-5 bg-gray-50 rounded-xl mb-10 border border-gray-100">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="pb-1">
            ...
            <p className="text-gray-500 text-sm font-medium">Premium Black Cotton Shirt</p>
          </div>
          <div className="flex items-baseline justify-center md:justify-start gap-3">
            <span className="text-2xl font-bold text-gray-900">₹400</span>
            <span className="text-lg text-gray-400 line-through font-light">₹900</span>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="flex items-center gap-5 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-gray-500 font-medium">345 Verified Ratings</p>
              </div>
            </div>
            ...
            <div className="space-y-4 px-2">
              {ratingStats.map((stat, index) => (
                <div key={index} className="flex items-center gap-4">
                  <span className="text-xs font-bold w-14 text-gray-600">{5 - index} Star</span>
