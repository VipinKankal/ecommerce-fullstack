...
const FilterSections = () => {
  ...
  // Hook to manage URL query strings
    ...
    <div className="-z-50 space-y-5 bg-white">
      <div className="flex items-center justify-between h-[40px] px-9 lg:border-r">
        ...
        <Button
          ...
          size="small"
          sx={{ color: teal[600], fontWeight: "bold", textTransform: "lowercase" }}
        >
          clear all
        </Button>
      </div>
      ...
      <div className="px-9 space-y-6">
        ...
        <section>
          ...
          {brand.length > 5 && (
            <button onClick={handleExpendBrand} className="text-teal-600 hover:text-teal-900 block mt-2 text-sm">
        ...
        <section>
                  ...
                  label={
                    <div className="flex items-center gap-3">
                      ...
                      <div
                        ...
                        className={`h-4 w-4 rounded-full border ${item.name === "White" ? "border-gray-300" : "border-transparent"}`}
                      />
                    </div>
                  }
                />
          ...
          {colors.length > 5 && (
            <button onClick={handleExpendColor} className="text-teal-600 hover:text-teal-900 block mt-2 text-sm">
