    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
            ...
            <div className="bg-primary-color flex flex-col justify-center items-center text-white p-10 hidden lg:flex">
                ...
                <p className="text-xl">Thousands of sellers are growing their business with us.</p>
            </div>
            ...
            <div className="flex flex-col justify-center items-center p-5">
                <div className=" max-w-xl rounded-xl p-5">
                    {!isLogin ? (
                      <SellerAccountForm onRegisterSuccess={() => navigate('/seller/verify-email')} />
                    ) : (
                      <SellerLoginForm />
                    )}
                    ...
                    <div className="mt-10 text-center space-y-2">
                        <p className="text-gray-600">
                            {isLogin ? "Don't have an account?" : "Already have a seller account?"}
                        </p>
                        <Button 
                            fullWidth 
                            variant="text" 
