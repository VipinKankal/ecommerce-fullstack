...
const AddNewCouponFrom = () => {
    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'center', p: { xs: 2, lg: 10 } }}>
            <Paper 
                elevation={0} 
                sx={{ 
                    width: '100%', 
                        ...
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <DatePicker
                                    ...
                                    onChange={(val) => formik.setFieldValue('startDate', val ? val.toDate() : null)}
                                    slotProps={{
                                        textField: {
                                            fullWidth: true,
                            ...
                            <Grid size={{ xs: 12, sm: 6 }}>
                                <DatePicker
                                    ...
                                    minDate={formik.values.startDate ? dayjs(formik.values.startDate) : undefined} // Logical validation
                                    onChange={(val) => formik.setFieldValue('endDate', val ? val.toDate() : null)}
                                    slotProps={{
                                        textField: {
                                            fullWidth: true,
