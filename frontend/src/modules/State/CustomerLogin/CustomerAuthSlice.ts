...
import { signinSeller, logout as sellerLogout } from "../Seller/SellerAuthThunks";
import { adminLogout, adminSignin } from "../AdminAuthThunks";
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deactivateAccount.fulfilled, (state, action) => {
        state.message = (action.payload as { message?: string })?.message || "Account deactivated";
      })
