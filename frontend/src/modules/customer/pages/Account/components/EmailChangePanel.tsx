...
const EmailChangePanel = ({
  ...
  return (
    <div className="space-y-5 rounded-2xl border border-pink-100 bg-white p-4 shadow-sm duration-300 animate-in fade-in slide-in-from-top-2 sm:p-6">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-pink-50 text-pink-600">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="h-5 w-5">
            <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5A2.25 2.25 0 0119.5 19.5h-15A2.25 2.25 0 012.25 17.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15A2.25 2.25 0 002.25 6.75m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
          </svg>
        </div>
        <div>
          <p className="text-sm font-bold text-[#282c3f]">Update Email Address</p>
          <p className="text-[11px] font-medium text-gray-400">OTP will be sent to your new email.</p>
        </div>
      </div>
      ...
      {shouldShowOtpInput && (
        <p className="text-xs font-medium text-gray-500">OTP sent to {otpRequestedFor}</p>
      )}
