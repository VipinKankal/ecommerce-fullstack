...
const SellerLoginForm = () => {
  ...
  return (
    <Box sx={{ maxWidth: 400, mx: "auto", mt: 6, p: 3, boxShadow: 2, borderRadius: 2 }}>
      <Typography variant="h5" sx={{ mb: 3, textAlign: "center", fontWeight: "bold", color: "teal" }}>
        Seller Portal Login
      </Typography>
      ...
      <form onSubmit={formik.handleSubmit}>
          ...
          InputProps={{
            endAdornment: (
              <InputAdornment position="end">
                <Button onClick={handleSendOtp} disabled={loading || !formik.values.email}>
                  {loading && !formik.values.otp ? <CircularProgress size={20} /> : otpSent ? "Resend" : "Send OTP"}
                </Button>
              </InputAdornment>
            ),
          }}
        ...
        <Button
          ...
          variant="contained"
          type="submit"
          sx={{ mt: 3, py: 1.5, bgcolor: "teal", "&:hover": { bgcolor: "#00695c" } }}
